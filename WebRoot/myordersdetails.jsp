...
<html>
  ...
  <div style="position: absolute;top: 440px; width: 95%">
    <table align="center" width="75%" cellspacing="0" cellpadding="3"
    	...
    	<s:iterator id="ordersDtsItem" value="#request.ordersDtsList">
    		...
    		<td><img width="100px" src="mealimages/<s:property value="meal.mealImage" />" /></td>
  ...
  <s:select list="'快递 免邮'"></s:select>
   ...
   <input type="checkbox"><font  style="font-size: 13px;">匿名购买</font>&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <div style="background:url('image/jieb.png') ;width: 450px; height: 180px; position: absolute;left: 680px; top: 830px; " >
     <div style="margin-left: 280px; margin-bottom: 10px;">
       实付款：<font style="font-size: 30px; font-weight: bolder;" color="#463f3e">￥</font><font style="font-size: 30px; font-weight: bolder;" color="red"><s:property value="#count"/></font>
     </div>
    ...
    寄送至： ${sessionScope.user.address}
     ...
     <a href="payment.jsp?orderid=<s:property value="#order"/>&&paymoney=<s:property value="#count"/>"><img src="image/jie.png"></a>
     </div>
     </div>
      <div style="position:absolute; top:1020px; width:1348px; height:330px; background:#f5f5f5;">
